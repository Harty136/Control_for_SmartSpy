    ...
    function RedisOutNode(n) {
        ...
        this.on("input", function(msg) {
                if (msg != null) {
                    ...
                    if (k) {
                        if (this.structtype == "string") this.client.del(k)
                        else if (this.structtype == "set") this.client.srem(k,msg.payload)
                        else if (this.structtype == "list") this.client.rpop(k)
                        }
                    else this.warn("No key or topic set");
                    }
        });
    }
    
    RED.nodes.registerType("redis del",RedisOutNode);
